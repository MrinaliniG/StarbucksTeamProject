...
--insert into menu(itemName, price, category) values('mocha', 1.50, 'COFFEE');
--insert into menu(itemName, price, category) values('cappacino', 2.50, 'COFFEE');
--insert into menu(itemName, price, category) values('cream', 1.25, 'TOPPING');
--insert into menu(itemName, price, category) values('whipped cream', 1.50, 'TOPPING');